...
/* Courses dataset (edit freely) */
const courses = [
  {
    id: "efaw",
    name: "Emergency First Aid at Work (EFAW)",
    short: "One-day essential first aid for low-risk workplaces.",
    category: ["Health & Safety"],
    delivery: ["Classroom", "Blended"],
    duration: "1 day (7 hours)",
    locations: ["Dartford", "Heathrow"],
    price: 99,
    priceNote: "+ VAT",
    entry: [
      "Age 16+",
      "Good command of English",
      "Photographic ID on arrival"
    ],
  ...
  },
  {
    ...
    short: "Comprehensive workplace first aid for higher-risk settings.",
    category: ["Health & Safety"],
    delivery: ["Classroom", "Blended"],
    duration: "3 days (or 2 days + online pre-study)",
    locations: ["Dartford", "Heathrow"],
    price: 275,
    priceNote: "+ VAT",
  ...
  {
    id: "act-security",
    name: "ACT Security (ProtectUK)",
    short: "Counter terrorism eLearning designed for security operatives.",
    category: ["Security"],
    delivery: ["Online"],
    ...
    price: 0,
    priceNote: "FREE",
    entry: ["Suitable for anyone working in or with security teams"],
  ...
  {
    id: "act-awareness",
    name: "ACT Awareness (ProtectUK)",
    short: "Public counter terrorism awareness course.",
    category: ["Security"],
    delivery: ["Online"],
    ...
    price: 0,
    priceNote: "FREE",
    entry: ["Open to all staff and volunteers"],
  ...
  {
    id: "lone-working",
    name: "Lone Working for Security Operatives",
    short: "Practical strategies for safe, compliant lone working.",
    category: ["Security", "Compliance"],
    delivery: ["Online", "Classroom"],
    duration: "2–3 hours",
    locations: ["Online", "Dartford", "Heathrow"],
    price: 60,
    priceNote: "+ VAT",
  ...
  },
  {
    ...
    short: "Recognise asbestos risks and stay compliant on site.",
  ...
  {
    id: "care-cert",
    name: "Care Certificate (15 Standards)",
    short: "Induction for new care workers covering core standards.",
    category: ["Care"],
    delivery: ["Blended", "Online"],
    duration: "Self-paced + observations",
    locations: ["Online + workplace"],
    price: 199,
    priceNote: "+ VAT",
  ...
  {
    id: "calorie",
    name: "Calorie Labelling for Food Businesses",
    short: "Understand requirements and implement compliant menus.",
    category: ["Compliance", "Food & Nutrition"],
    delivery: ["Online"],
    duration: "1–2 hours",
    locations: ["Online"],
    price: 49,
  ...
  },
  {
    ...
    short: "Build inclusive teams and meet Equality Act duties.",
    category: ["Compliance"],
    delivery: ["Online"],
    duration: "1.5 hours",
    locations: ["Online"],
  ...
  {
    id: "gdpr",
    name: "General Data Protection Regulation (GDPR) Essentials",
    short: "Handle personal data lawfully, fairly and securely.",
    category: ["Compliance"],
    delivery: ["Online"],
    duration: "2–3 hours",
    locations: ["Online"],
    ...
    return `
      <article class="course fade-in" data-id="${c.id}">
        ...
        <div class="course-actions">
          ${c.externalLink ? `
            <a class="btn btn-outline" target="_blank" rel="noopener" href="${c.externalLink}">Go to ProtectUK</a>
          ` : ""}
...
form.addEventListener("reset", () => {
  setTimeout(() => {
    ££('fieldset.checks input').forEach(i => i.checked = false);
    applyFilters();
  }, 0);
});
applyFilters();
